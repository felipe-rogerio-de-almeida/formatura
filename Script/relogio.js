...
function atualizarRelogio() {
  ...
  if (tempoRestante < 0){
    ...
    document.getElementById('dia1').innerHTML = 0;
    document.getElementById('dia2').innerHTML = 0;
    document.getElementById('hora1').innerHTML = 0;
    document.getElementById('hora2').innerHTML = 0;
    document.getElementById('minuto1').innerHTML = 0;
    document.getElementById('minuto2').innerHTML = 0;

    document.querySelector('.comemorarTitulo').innerHTML = 'NOSSA FESTA FOI LINDA!'
